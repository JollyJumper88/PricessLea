 ...
 */
public class MyPreferenceActivity extends PreferenceActivity implements DonationDialogFragment.DialogFragmentListener {
    ...
    public void onDialogFragmentClick(int button) {
        // we do not need to do anything when the dialog gets dismissed
    }
